    ...
    <section id="projects" className="bg-neutral-800">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[135vh] grid-cols-4 grid-rows-3 gap-7">
          ...
          <ProjectTilt className="project-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <ProjectCard
          ...
          <ProjectTilt className="project-tilt_1 me-14 md:col-span-1 md:me-0">
            <ProjectCard
          ...
          <ProjectTilt className="project-tilt_2">
            <div className="flex fize-full flex-col justify-between bg-stone-100 p-5">
